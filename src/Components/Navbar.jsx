    ...
    <nav className="bg-transparent border-gray-200 py-2.5">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center p-2 ml-3 text-sm text-neutral rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
