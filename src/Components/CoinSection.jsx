      ...
      <div className="mx-auto container">
        <div className="mx-auto max-w-5xl container pb-0 pt-80 md:pt-64">
          <div className="flex flex-col justify-between space-y-12 items-center">
            ...
            <div className="coins flex flex-col md:flex-row justify-between space-y-6 lg:space-x-6 md:space-x-3 md:space-y-0">
              <div className="coin flex flex-col justify-between items-center md:space-y-10 space-y-8 shadow rounded-md bg-primary p-8 md:p-3 lg:p-5 text-center">
                ...
                <p className="text-white text-sm font-normal w-64">
              ...
              <div className="coin flex flex-col justify-between items-center md:space-y-10 space-y-8 shadow rounded-md bg-white p-8 md:p-5 text-center">
                ...
                <p className="text-[#828282] text-sm font-normal w-64">
